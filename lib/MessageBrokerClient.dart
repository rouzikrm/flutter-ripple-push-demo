...
class MessageBroker{
MessageBroker({String brokerEndpoint,String topic,String clientId}):
 this.topic =topic, this.clientId =clientId,
 client = MqttClient(brokerEndpoint,'');
...
Future<int> connect() async {
  ...
  client.subscribe(this.topic, MqttQos.atMostOnce);
